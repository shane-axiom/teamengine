...
<package xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.occamlab.com/ctl"
	xmlns:parsers="http://www.occamlab.com/te/parsers" xmlns:p="http://teamengine.sourceforge.net/parsers"
	xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:soap="http://www.w3.org/2003/05/soap-envelope"
	xmlns:saxon="http://saxon.sf.net/" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2"
	xmlns:csw2="http://www.opengis.net/cat/csw/2.0.2" xmlns:ows="http://www.opengis.net/ows"
	...
	<test name="csw:csw-main">
		...
		<code>
			...
			<xsl:variable name="csw.capabilities.url"
				select="$te:params/params/param[@local-name='csw.capabilities.url']" />

			<message>
				Capabilities request/URL used:
